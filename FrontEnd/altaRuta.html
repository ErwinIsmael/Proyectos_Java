...
<body>
    ...
    <div class="container body-content">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <button class="btn btn-success" id="btnaltaruta" onclick="GuardarRuta();">Iniciar Ruta</button>
                </div>
    ...
    <script>
      ...
      var camionesArray = <%= new Gson().toJson(camiones) %>;
        //Funcion para obtener la capacidad del camion y recuperar el valor en capacidad
         ...
         const showLoading = function() {
            swal({
                title: 'Un momento, se esta guardando los datos!',
                closeOnEsc: false,
      ...
      swal.showLoading();
            ...
            $("#btnaltaruta").prop('disabled',true)
            };
          ...
          function btnGuardarDir(){
            ...
            $.ajax({
                ...
                success: function(resp) {
                    ...
                    $("#btnaltaruta").prop('disabled',false)
                }
            });
        ...
        showLoading();
            ...
            var camoinId =  $("#camion").val();
            var choferId =  $("#chofer").val();
            var direccionOrigenId =  $("#idOrigen").val();
            var direccionDestinoId =  $("#idDestino").val();
            var distancia =  $("#distancia").val();
            var fechaSalida =  $("#FSalida").val();
            var fechaLlegadaEstimada =  $("#FELlegada").val();
            var capCamion = $("#capCamion").val();

             $.ajax({
                    type:'POST',
                    url: "http://localhost:8080/Gen1-Rutas/rutas/alta",
                    data: {"camoinId":camoinId, "choferId":choferId, "direccionOrigenId":direccionOrigenId, "direccionDestinoId":direccionDestinoId,
                    "distancia":distancia, "fechaSalida":fechaSalida,"capCamion":capCamion, "fechaLlegadaEstimada":fechaLlegadaEstimada},
                    success: function(resp){
                        swal.close();
                        console.log(resp);
