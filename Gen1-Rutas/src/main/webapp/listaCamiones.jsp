                    ...
                    <table class="table table-bordered table-striped" id="Cadena" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            <% for(Camion c: camiones){ %>
                                ...
                                <td><a href="<%=request.getContextPath()%>/camiones/detalle?id=<%=c.getId()%>" class="btn btn-success">Detalle</a></td>
                                <td><a href="<%=request.getContextPath()%>/camiones/editar?id=<%=c.getId()%>" class="btn btn-primary">Editar</a></td>
                                <td><a href="<%=request.getContextPath()%>/camiones/eliminar?id=<%=c.getId()%>" class="btn btn-danger">Eliminar</a></td>
                            </tr>
                            <% } %>
                        </tbody>
                    </table>
