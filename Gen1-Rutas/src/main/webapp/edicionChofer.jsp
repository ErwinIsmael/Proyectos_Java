                ...
                <form action="<%=request.getContextPath()%>/choferes/editar" method="post">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <!-- input:text[name=Cadena][id=Cadena].form-control[value=Cadena] -->
                            <input type="text" name="apPaterno" id="apPaterno" class="form-control" value="<%=chofer.getNombre() != null? chofer.getApMaterno(): ""%>">
                            <%
                        ...
                        <div class="form-group">
                            ...
                            <!-- input:text[name=Cadena][id=Cadena].form-control[value=Cadena] -->
                            <input type="text" name="apMaterno" id="apMaterno" class="form-control" value="<%=chofer.getNombre() != null? chofer.getApMaterno(): ""%>">
                            <%
                        ...
                        <div class="form-group">
                            ...
                            <!-- input:text[name=Cadena][id=Cadena].form-control[value=Cadena] -->
                            <input type="text" name="licencia" id="licencia" class="form-control" value="<%=chofer.getNombre() != null? chofer.getLicencia(): ""%>">
                            <%
                    ...
                    -->
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="fechaNacimiento" id="fechaNacimiento" class="form-control datepicker" value="<%=fecha%>">
                            <%
                                if (errores != null && errores.containsKey("fechaNacimiento")) {
                                    out.println("<span class='text-danger'>" + errores.get("fechaNacimiento") + "</span>");
                                }
