 ...
 */
        ...
        ICargador cargadorNormalApple = new CargadorNormalApple();
        ICargador cargadorCompactoApple = new CargadorCompactoApple();

        ICargador cargadorSuperSamsung = new CargadorSuperSamsung();
        ICargador cargadorNormalSamsung = new CargadorNormalSamsung();
        ICargador cargadorInduccionSamsung = new CargadorInduccionSamsung();

        ICargador cargadorNormalXiaomi = new CargadorNormalXiaomi();
        ICargador cargadorSuperXiaomi = new CargadorSuperXiaomi();
